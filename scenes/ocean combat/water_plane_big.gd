...
func _ready() -> void:
	...
	# We'll have to fix this later. Apparently mesh.surface_get_material returns null.
	# Maybe need to put it on the original scene not the instantiated one.
	# ALSO GET THIS CHECKED INTO GIT ALREADY!
